...
# 其他参数和 Weather.sh 保持一致
# ============================================================

RESULT_FILE="./result_Weather_grid.txt"
...
TASKS=(
    "weather_320_96|320|96|3|1|CDA"
    "weather_320_192|320|192|3|4|CDA"
    "weather_320_336|320|336|2|8|CDA"
    "weather_320_720|320|720|2|8|CDA"
)
...
echo "=== Weather MoE Grid Search: $(date) ==="
